...
export interface AnalysisAllowance { periodKey: string; baseLimit: number; rewardCount: number; adminGrantedCount: number; usedCount: number; rewardedToday: boolean; lastRewardedAt?: string }
