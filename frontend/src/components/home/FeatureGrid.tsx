...
export function FeatureGrid() {
  const { t } = useLanguage()
  const features = [
    { title: t.home.featureReviewTrust, desc: t.home.featureReviewTrustDesc, icon: CheckCircle2, tone: styles.iconLavender },
    { title: t.home.featureAdDetection, desc: t.home.featureAdDetectionDesc, icon: Siren, tone: styles.iconPink },
    { title: t.home.featurePlace, desc: t.home.featurePlaceDesc, icon: MapPinned, tone: styles.iconMint },
    { title: t.home.featureForeigner, desc: t.home.featureForeignerDesc, icon: Globe2, tone: styles.iconLavender },
  ]
