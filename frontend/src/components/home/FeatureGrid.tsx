...
import { Bot, CheckCircle2, Globe2, MapPinned, Siren } from "lucide-react"
...
export function FeatureGrid() {
  ...
  const features = [
    ...
    { title: t.home.featureChatbot, desc: t.home.featureChatbotDesc, icon: Bot, tone: styles.iconLavender },
  ]
