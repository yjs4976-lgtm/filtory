...
from app.api.review_analysis_api import _verify_internal_token


def test_internal_token_configuration_is_required():
...
def test_internal_token_header_is_required():
    with pytest.raises(HTTPException) as exc:
...
def test_matching_internal_token_is_accepted():
