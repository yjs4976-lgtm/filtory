...
class Config:
    ...
    LOGIN_FAILURE_WINDOW_MINUTES = int(os.getenv("LOGIN_FAILURE_WINDOW_MINUTES", "10"))
    ...
    TOSS_API_TIMEOUT_SECONDS = max(60, _float_or_default(os.getenv("TOSS_API_TIMEOUT_SECONDS"), 70))
